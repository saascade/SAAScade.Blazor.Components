...
public class HanddrawnAssessibleDesignSystem : IDesignSystem
{
    ...
    public string DisplayName { get; } = nameof(HanddrawnAssessibleDesignSystem).Replace("DesignSystem", "").Humanize();
    ...
    public string[] GetStylesheetReferences() =>
        [
            ...
            """ <link rel="stylesheet" href="_content/Saascade.Blazor.Components.DesignSystems.VanillaCss/handdrawn/css/handdrawn.assessible.min.css" /> """
        ];
