...
public class HanddrawnBlackAndWhiteDesignSystem : IDesignSystem
{
    ...
    public string DisplayName { get; } = nameof(HanddrawnBlackAndWhiteDesignSystem).Replace("DesignSystem", "").Humanize();
    ...
    public string[] GetStylesheetReferences() =>
        ...
        """ <link rel="stylesheet" href="_content/Saascade.Blazor.Components.DesignSystems.VanillaCss/handdrawn/css/handdrawn.bw.min.css" /> """
        ];
