...
public class SoftPinkV1DesignSystem : IDesignSystem
{ 
    public string DisplayName { get; } = nameof(SoftPinkV1DesignSystem).Replace("DesignSystem", "").Humanize();
    ...
    [
        """ <link rel="stylesheet" href="_content/Saascade.Blazor.Components.DesignSystems.SaascadeLtd/SoftPink/v1/css/styles.css" /> """,
    ];
    ...
    [
        //TODO
        """ TODO href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" """, 
    ];
}